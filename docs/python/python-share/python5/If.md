...
![if语句流程图](https://minio.testwn.com/img/blog/168425321507627.webp)
...
![](https://minio.testwn.com/img/blog/168425321509189.png)

可见，把结果打印出来了。

那如果我们把 `num ` 改为空字符串呢？

![](https://minio.testwn.com/img/blog/168425321508878.png)

很明显，空字符串是为 False 的，不符合条件语句，因此不会执行到  `print('Hello Python')`  这段代码。

还有再啰嗦一点，提醒一下，在条件判断代码中的冒号 `:` 后、下一行内容是一定要缩进的。不缩进是会报错的。

![](https://minio.testwn.com/img/blog/168425321510562.png)
...
![](https://minio.testwn.com/img/blog/168425321510661.png)
