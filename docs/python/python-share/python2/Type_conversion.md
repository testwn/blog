...
![](https://minio.testwn.com/img/blog/168425316243030.png)

输出结果：

![](https://minio.testwn.com/img/blog/168425316243094.png)

注意这里是符合规则的字符串类型，如果是文字形式等字符串是不可以被 `int()` 函数强制转换的。

还有小数形式的字符串也是不能用  `int()`  函数转换的。

![](https://minio.testwn.com/img/blog/168425316265224.png)

这样转换会报错。

![](https://minio.testwn.com/img/blog/168425316243075.png)
...
![](https://minio.testwn.com/img/blog/168425316244280.png)

输出结果：

![](https://minio.testwn.com/img/blog/168425316244926.png)
